...
void AFPSAIGuard::OnHearNoise(APawn* HeardActor, const FVector& Location, float Volume)
{
	...
	DrawDebugSphere(GetWorld(), Location, 32.0f, 12, FColor::Purple, false, 10.0f);
	...
	GetWorldTimerManager().SetTimer(TimerHandle_ResetRotation, this, &AFPSAIGuard::ResetRotation, 3.0f);
